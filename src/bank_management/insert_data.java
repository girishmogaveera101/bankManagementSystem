...
public class insert_data {
    ...
    insert_data(){
        try{
            ...
            stt.execute("INSERT INTO user (id,pass,ac_type,join_date,nation,nid,name,p_number,dob,address)"
                        +"SELECT * FROM (SELECT '10001019', 'passpass','Student','2017-01-10','Bangladeshi','1111111119','cristiano','01710000019','1995-01-02',' Uttara, Dhaka') AS tmp WHERE NOT EXISTS ("+"SELECT id FROM user WHERE id = '10001019'" +")");
...
//money table and insert
            ...
            //             +"SELECT * FROM (SELECT '10001000','Md. Abdullah','500') AS tmp WHERE NOT EXISTS ("+"SELECT id FROM money WHERE id = '10001000'" +")");
            // stt.execute("INSERT INTO money (id,name,amount)"
